...
<head>
	...
	<input type="hidden" id="studentGuid" value="${student_guid}"/>
	<input type="hidden" id="classguid" value="${class_guid}"/>
	<input type="hidden" id="enteredSubjectAndMarks"/>
    <div class="row">
                	...
                	<fieldset class="form-horizontal">
						<div class="control-group">
								...
								<div class="controls">
									...
									<a class="btn btn-primary" href="javascript:getSubjectAndMarks()">Load Subjects And Marks</a>
									<a class="btn btn-primary" href="javascript:getStudentReportCard('html')">Get Report Card (HTML)</a>
									<a class="btn btn-primary" href="javascript:getStudentReportCard('pdf')">Get Report Card (PDF)</a>
								</div>
						</div>
        ...
        <div class="box-inner">
            <div class="box-content">
				<div class="form-actions">
					<a class="btn btn-primary" href="javascript:saveSubjectAndMarks()">Save changes</a>
