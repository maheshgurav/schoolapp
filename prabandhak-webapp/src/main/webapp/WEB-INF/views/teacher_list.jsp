...
<head>
	...
	<title>School Management System - Teachers</title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-info-sign"></i> Teachers</h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addteacher.htm">
							Add new teacher
						</a>
                </div>
			</div>
			...
			<div class="box-content">
				...
				<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tr>
								...
								<td class="center">
									<!--<a class="btn btn-success" href="viewteacher.htm?id=${student.editId}">
										<i class="icon-zoom-in icon-white"></i>  
										View                                            
									</a>-->
									<a class="btn btn-info" href="editteacher.htm?id=${teacher.teacher.guid}">
