...
<head>
	...
	<title>School Management System - Castes </title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Castes </h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addcaste.htm">
							Add New Caste
						</a>
                </div>
			</div>
							...
							<tr>
								...
								<core:choose>
									<core:when test="${caste.isMinority}">
										<td><span class="label label-success">Minority</span></td>
									</core:when>
									<core:otherwise>
										<td><span class="label label-warning">Non-minority</span></td>
									</core:otherwise>	
								</core:choose>
								<td class="center">
									<a class="btn btn-info" href="editcaste.htm?id=${caste.guid}">
