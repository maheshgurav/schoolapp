...
<head>
	...
	<title>School Management System - Income</title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Income</h2>
                <div class="box-icon">
                	<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addincome.htm">
							Add Income Details
					</a>
                </div>
			</div>
			...
			<div class="box-content">
			   <!--<div class="btn-group">
			        <a class="btn btn-info" href="addincome.htm"><i class="glyphicon glyphicon-plus"></i> Add income details</a>
               </div>
				
               <div class="btn-group">
               		<a class="btn btn-info" href="addincome.htm"><i class="glyphicon glyphicon-plus"></i> Add new income reason</a>
               </div>-->
               <div class="clear-both"></div>
				...
				<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tbody>
						  <core:if test="${incomes.size() > 0}">
						  <core:forEach var="income" items="${incomes}">
						  <tr>
								<td class="center">${income.dateOfIncome}</td>
								<td class="center">${income.incomeDetails.incomeFrom}</td>
								<td class="center">${income.incomeDetails.amount}</td>
								<td class="center">
									<a class="btn btn-info" href="editincome.htm?id=${income.incomeDetails.guid}">
