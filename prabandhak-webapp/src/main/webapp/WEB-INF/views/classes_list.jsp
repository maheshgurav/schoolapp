...
<head>
	...
	<title>School Management System - Classes</title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Classes </h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addclass.htm">
							Add New Class
						</a>
                </div>
			</div>
					...
					<core:if test="${classes.size() > 0}">
						<core:forEach var="classinfo" items="${classes}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="editclass.htm?id=${classinfo.guid}">
