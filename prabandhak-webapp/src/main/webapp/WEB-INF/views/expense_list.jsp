...
<head>
	...
	<title>School Management System - Expense</title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Expense</h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addexpense.htm">
							Add Expense Details
						</a>
                </div>
			</div>
			...
			<div class="box-content">
				...
				<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tr>
								...
								<td class="center">
									<a class="btn btn-info" href="editexpense.htm?id=${expense.expenseDetails.guid}">
