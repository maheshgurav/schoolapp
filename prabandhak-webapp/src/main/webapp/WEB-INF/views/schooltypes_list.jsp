...
<head>
	<meta charset="utf-8">
	<title>School Management System - School types</title>
		<!-- topbar starts -->
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> School Types</h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addschooltype.htm">
							Add New School Type
						</a>
                </div>
			</div>
					...
					<core:if test="${schooltypes.size() > 0}">
						<core:forEach var="schooltype" items="${schooltypes}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="editschooltype.htm?id=${schooltype.guid}">
