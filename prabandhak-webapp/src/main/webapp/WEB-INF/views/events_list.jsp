...
<head>
	...
	<title>School Management System - Events </title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Events </h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addevent.htm?date=${date}">
							Add New Event
						</a>
                </div>
			</div>
					...
					<core:if test="${events.size() > 0}">
						<core:forEach var="event" items="${events}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="editevent.htm?id=${event.event.guid}">
