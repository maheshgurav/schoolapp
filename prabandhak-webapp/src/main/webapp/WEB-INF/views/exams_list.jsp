...
<head>
	...
	<title>School Management System - Exams</title>
		...
		<div class="container-fluid">
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Exams </h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addexam.htm">
							Add New Exam
						</a>
                </div>
			</div>
					...
					<core:if test="${exams.size() > 0}">
						<core:forEach var="exam" items="${exams}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="editexam.htm?id=${exam.guid}">
