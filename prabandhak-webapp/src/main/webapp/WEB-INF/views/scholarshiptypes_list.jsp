...
<head>
	<meta charset="utf-8">
	<title>School Management System - Scholarship types</title>
		<!-- topbar starts -->
		...
		<div class="container-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<span><b>Scholarship types</b></span>
					</li>
				</ul>
			</div>
    		...
    		<h2><i class="glyphicon glyphicon-leaf"></i> Scholarship types</h2>
                <div class="box-icon">
						<a class="btn btn-info" style="width:100%;height:25px;padding:1px;" href="addscholarshiptype.htm">
					...
					<core:if test="${scholarshiptypes.size() > 0}">
						<core:forEach var="scholarshipinfo" items="${scholarshiptypes}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="editscholarshiptype.htm?id=${scholarshipinfo.guid}">
