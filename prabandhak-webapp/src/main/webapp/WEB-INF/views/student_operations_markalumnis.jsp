...
<head>
	<meta charset="utf-8">
	<title>School Management System - Mark Alumnis</title>
                	...
                	<fieldset class="form-horizontal">
						...
						<div class="box-content">
							<div class="form-actions">
								<a class="btn btn-primary" href="javascript:getStudentsForAlumni()">Show students</a>
							</div>
						</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-content">
				<div class="form-actions">
					<a class="btn btn-primary" href="javascript:markAlumnis()">Mark Alumnis</a>
