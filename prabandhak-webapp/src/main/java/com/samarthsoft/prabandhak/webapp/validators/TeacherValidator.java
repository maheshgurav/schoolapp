...
public class TeacherValidator implements Validator{
	...
	public void validate(Object object, Errors errors) {
		...
		if(ValidatorCommon.checkFieldNullOrEmpty(teacherFormObject.getName().getFirstName()))
			errors.rejectValue("name.firstName", "Error.Empty.First.Name","Error.Empty.First.Name");
		if(ValidatorCommon.checkFieldNullOrEmpty(teacherFormObject.getName().getMiddleName()))
				errors.rejectValue("name.middleName", "Error.Empty.Middle.Name","Error.Empty.Middle.Name");
		if(ValidatorCommon.checkFieldNullOrEmpty(teacherFormObject.getName().getLastName()))
					errors.rejectValue("name.lastName", "Error.Empty.Last.Name","Error.Empty.Last.Name");
