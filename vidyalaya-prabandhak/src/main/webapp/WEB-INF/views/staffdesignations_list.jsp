...
<head>
	<meta charset="utf-8">
	<title>School Management System - Supporting Staff Designations</title>
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Supporting Staff Designations
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Supporting Staff Designations</li>
			<li><a class="badge bg-light-blue" href="addstaffdesignation.htm"><i class="fa fa-plus"></i> Add Staff Designations</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
...
<section class="content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				...
				<tbody>
					<core:if test="${staffdesignations.size() > 0}">
						<core:forEach var="staffdesignation" items="${staffdesignations}">
							<tr>
								<td>${staffdesignation.name}</td>
								<td class="center">
									<a class="btn btn-default" href="editstaffdesignation.htm?id=${staffdesignation.name}">
	...
	<div class="row">
		<div class="col-md-12">
		<core:choose>		
			<core:when test="${staffdesignations.size() > 0}">
				<ul class="pager">
				<core:choose>
			...
			<core:otherwise>
				<div class="alert alert-block span10">
					<!--<h4 class="alert-heading">Warning!</h4>-->
						<p>No Staff Designations Found.</p>
				</div>
			</core:otherwise>
		</core:choose>
	</div>	
