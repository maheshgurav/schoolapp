...
<head>
	<meta charset="utf-8">
	<title>School Management System - Events</title>
...
<section class="content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						<th><spring:message code="Header.Event.Name"/></th>
						<th><spring:message code="Header.Event.Date"/></th>
						<th><spring:message code="Header.Type.Of.Event"/></th>
					</tr>
				</thead>   
				<tbody>
					<core:if test="${events.size() > 0}">
						<core:forEach var="event" items="${events}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-default" href="editevent.htm?id=${event.event.guid}">
	...
	<div class="row">
		<div class="col-md-12">
		<core:choose>		
			<core:when test="${categories.size() > 0}">
				<ul class="pager">
				<core:choose>
			...
			<core:otherwise>
				<div class="alert alert-block span10">
					...
					<p><spring:message code="Error.No.Events.Found"/></p>
				</div>
			</core:otherwise>
		</core:choose>
	</div>	
