...
<head>
	<meta charset="utf-8">
	<title>School Management System - School Type</title>
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addschooltype.htm"><i class="fa fa-plus"></i> Add School Type</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
...
<section class="content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						<th><spring:message code="Header.Type.Of.School"/></th>
						<th><spring:message code="Header.Actions"/></th>
					</tr>
				</thead>   
				<tbody>
					<core:if test="${schooltypes.size() > 0}">
						<core:forEach var="schooltype" items="${schooltypes}">
							<tr>
								<td>${schooltype.name}</td>
								<td class="center">
									<a class="btn btn-default" href="editschooltype.htm?id=${schooltype.guid}">
	...
	<div class="row">
		<div class="col-md-12">
		<core:choose>		
			<core:when test="${schooltypes.size() > 0}">
				<ul class="pager">
				<core:choose>
			...
			<core:otherwise>
				<div class="alert alert-block span10">
						<p><spring:message code="Label.No.School.Types.Found"/></p>
				</div>
			</core:otherwise>
		</core:choose>
	</div>	
