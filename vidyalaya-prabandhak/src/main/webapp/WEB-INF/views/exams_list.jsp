...
<head>
	<meta charset="utf-8">
	<title>School Management System - Exams</title>
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addexam.htm"><i class="fa fa-plus"></i> Add Exam</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						<th><spring:message code="Header.Name.Exam"/></th>
						<th><spring:message code="Header.For.Standard"/></th>
						<th>Actions</th>
					</tr>
				</thead>   
				<tbody>
					<core:if test="${exams.size() > 0}">
						<core:forEach var="exam" items="${exams}">
							<tr>
								<td>${exam.name}</td>
								<td>${exam.standards}</td>
								<td class="center">
									<a class="btn btn-default" href="editexam.htm?id=${exam.guid}">
