...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addsubject.htm"><i class="fa fa-plus"></i> Add Subject</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
...
<section class="content">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						...
						<th><spring:message code="Header.Code"/></th>
						<th><spring:message code="Header.Default.For.Classes"/></th>
					...
					<core:if test="${subjects.size() > 0}">
						<core:forEach var="subject" items="${subjects}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-default" href="editsubject.htm?id=${subject.guid}">
	...
	<div class="row">
		<div class="col-md-12">
		<core:choose>		
			<core:when test="${subjects.size() > 0}">
				<ul class="pager">
				<core:choose>
			...
			<core:otherwise>
				<div class="alert alert-block span10">
						<p><spring:message code="Label.No.Subject.Found"/></p>
				</div>
			</core:otherwise>
		</core:choose>
	</div>	
