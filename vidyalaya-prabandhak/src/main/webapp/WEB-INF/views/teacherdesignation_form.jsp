...
<head>
	<meta charset="utf-8">
	<title>School Management System - Teacher Designation</title>
...
<div class="content-wrapper">
    ...
    <li class="active">Add/Edit Teacher Designation</li>
    </ol>
    </section>
	<!--
	<div class="col-md-3">
...
<section class="content">
	...
	<form:form commandName="teacherdesignation" method="POST" name="teacherdesignation">
