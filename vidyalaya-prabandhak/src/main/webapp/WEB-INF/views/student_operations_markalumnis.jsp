...
<head>
	<meta charset="utf-8">
	<title>School Management System - Generate Leaving Certificates</title>
...
<div class="content-wrapper">
    ...
    <li class="active">Generate Leaving Certificates</li>
    </ol>
    </section>
	<!--
	<div class="col-md-3">
  ...
  <div class="box box-default">
    <div class="box-body">
	  		<div class="form-actions">
					<a class="btn btn-default" href="javascript:markAlumnis()"><spring:message code="Label.Mark.Alumnus"/></a>
