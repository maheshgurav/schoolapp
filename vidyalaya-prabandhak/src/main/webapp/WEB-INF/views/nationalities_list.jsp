...
<head>
	<meta charset="utf-8">
	<title>School Management System - Nationality</title>
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addnationality.htm"><i class="fa fa-plus"></i> Add Nationality</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
...
<section class="content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				...
				<tbody>
					<core:if test="${nationalities.size() > 0}">
						<core:forEach var="nationality" items="${nationalities}">
							<tr>
								<td>${nationality.name}</td>
								<td class="center">
									<a class="btn btn-default" href="editnationality.htm?id=${nationality.name}">
	...
	<div class="row">
		<div class="col-md-12">
		<core:choose>		
			<core:when test="${nationalities.size() > 0}">
				<ul class="pager">
				<core:choose>
			...
			<core:otherwise>
				<div class="alert alert-block span10">
					<!--<h4 class="alert-heading">Warning!</h4>-->
						<p>No Nationality Details Found.</p>
				</div>
			</core:otherwise>
		</core:choose>
	</div>	
