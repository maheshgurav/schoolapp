...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addcategory.htm"><i class="fa fa-plus"></i> Add Category</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						<th><spring:message code="Label.Name.Category"/></th>
						<th>Actions</th>
					</tr>
				</thead>   
				<tbody>
					<core:if test="${categories.size() > 0}">
						<core:forEach var="category" items="${categories}">
							<tr>
								<td>${category.name}</td>
								<td class="center">
									<a class="btn btn-default" href="editcategory.htm?id=${category.guid}">
