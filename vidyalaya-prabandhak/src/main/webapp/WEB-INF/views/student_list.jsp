...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addstudent.htm"><i class="fa fa-plus"></i> Add Student</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
					...
					<core:if test="${students.size() > 0}">
						<core:forEach var="student" items="${students}">
							<tr>
								...
								<td class="center"><a href="editstudent.htm?id=${student.editId}">${student.student.name.toString()}</a></td>
								<td class="center">${student.birthDate}</td>
								<td class="center">${student.student.caste}</td>
								<td class="center">${student.student.standard}</td>
								<td class="center">
									<a class="btn btn-default" href="editstudent.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-pencil glyphicon glyphicon-white"></i>
									</a>

									<a class="btn btn-default" href="editstudentcontactdetails.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-envelope glyphicon glyphicon-white"></i>
									</a>

									<a class="btn btn-default" href="setsubjects.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-book glyphicon glyphicon-white"></i>
									</a>

									<a class="btn btn-default" href="editparentdetails.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-edit glyphicon glyphicon-white"></i>
									</a>

									<a class="btn btn-default" href="javascript:getBonafide('${student.editId}')">
										<i class="glyphicon glyphicon-white">B</i> 
									</a>
									
									<a class="btn btn-default" href="leavingcertificate.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-white">LC</i>
									</a>

									<a class="btn btn-default" href="fillindividualstudentmarks.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-white">E</i> 
									</a>
									
									<a class="btn btn-default" href="removestudentfromcatalogue.htm?id=${student.editId}">
										<i class="glyphicon glyphicon-trash glyphicon glyphicon-white"></i> 
									</a>

									<a class="btn btn-default" href="changeclassordivisionofstudent.htm?id=${student.editId}">
