...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addincome.htm"><i class="fa fa-plus"></i> Add Income</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						...
						<th><spring:message code="Label.Income.From"/></th>
					...
					<core:if test="${incomes.size() > 0}">
						<core:forEach var="income" items="${incomes}">
							<tr>
								...
								<td class="center">
									<a class="btn btn-default" href="editincome.htm?id=${income.incomeDetails.guid}">
			...
			<core:otherwise>
				<div class="alert alert-block span10">
					<!--<h4 class="alert-heading">Warning!</h4>-->
						<p><spring:message code="Error.No.Income.Details.Found"/></p>
				</div>
			</core:otherwise>
		</core:choose>
	</div>	
