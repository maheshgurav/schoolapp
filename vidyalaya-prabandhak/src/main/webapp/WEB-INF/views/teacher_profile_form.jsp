...
<head>
	<meta charset="utf-8">
	<title>School Management System - Teacher Profile</title>
            ...
            <div class="box-body">
				...
				<div class="col-md-3">
				  <div class="form-group">
					...
					<div class="controls">
						<form:select path="teacher.designation" data-rel="chosen" disabled="disabled">
...
<%-- 				<div class="col-md-3">
				  <div class="form-group">
					<label class="control-label" for="focusedInput"><spring:message code="Label.Class.Teacher.For"/></label>
					<div class="controls">
