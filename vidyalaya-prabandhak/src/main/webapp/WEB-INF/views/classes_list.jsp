...
<head>
	<meta charset="utf-8">
	<title>School Management System - Classes</title>
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a class="badge bg-light-blue" href="addclass.htm"><i class="fa fa-plus"></i> Add Class</a></li>
          </ol>
        </section>
	<!--
	<div class="col-md-3">
			...
			<table class="table table-hover">
				<thead>
					<tr>
						...
						<th><spring:message code="Label.Type.Of.School"/></th>
						<th>Actions</th>
					</tr>
				</thead>   
				<tbody>
					<core:if test="${classes.size() > 0}">
						<core:forEach var="classinfo" items="${classes}">
							<tr>
								<td>${classinfo.standardOrClass}</td>
								<td class="center">${classinfo.division}</td>
								<td class="center">${classinfo.schoolTypeGuid}</td>
								<td class="center">
									<a class="btn btn-default" href="editclass.htm?id=${classinfo.guid}">
